                      ...
                      children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Text("Tawfer Card", style: TextStyle(fontStyle: FontStyle.italic, fontSize: 28, color: Colors.white, fontWeight: FontWeight.w900),)
                          ],
                        ),
                        SizedBox(height: 32,),
                          ...
                          children: <Widget>[
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("Maha Mari", style: TextStyle(fontSize: 16, color: Colors.grey[100], fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                              ],
                            ),
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("8/27", style: TextStyle(fontSize: 16, color: Colors.grey[100], fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                              ],
                            ),
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                Text("844", style: TextStyle(fontSize: 16, color: Colors.grey[100], fontWeight: FontWeight.w700, letterSpacing: 2.0),),
                              ],
                            )
                          ],
                        )
